        ...
        children: [
            {
                path: 'home',
                loadComponent: () =>
                    import('../../features/dashboard/components/home/home.component').then(m => m.Home),
            },
            {
                path: 'users',
                loadComponent: () =>
                    import('../../features/dashboard/components/users/users.component').then(m => m.Users),
            },
            {
                path: 'roles',
                loadComponent: () =>
            ...
            },
            {
                path: 'orders',
                loadComponent: () =>
                    import('../../features/dashboard/components/orders/orders.component').then(m => m.Orders),
            },
            {
                path: 'sales',
                loadComponent: () =>
